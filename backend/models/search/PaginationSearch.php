...
/**
 * PaginationSearch represents the model behind the search form about `backend\models\Pagination`.
 */
class PaginationSearch extends Pagination implements IContentSearch
{
    /**
     * @inheritdoc
     */
