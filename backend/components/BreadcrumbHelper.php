...
class BreadcrumbHelper
{
     ...
     * @param $model
     */
    public static function handleIndex($viewData, $extraData, $model)
    {
     ...
     * @param $model
     */
    public static function handleSort($viewData, $extraData, $model)
    {
     ...
     * @param object $model
     */
    public static function handleCreate($viewData, $extraData, $model)
    {
     ...
     * @param object $model
     */
    public static function handleUpdate($viewData, $extraData, $model)
    {
     ...
     * @param object $model
     */
    public static function handleView($viewData, $extraData, $model)
    {
        $field = self::getField($extraData);
        if (array_key_exists('customTitle', $extraData)) {
